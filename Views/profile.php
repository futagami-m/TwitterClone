                    ...
                    <!-- ログインIDによって表示を切り替える -->
                        ...
                        <!-- 相手のページ -->
                            <?php if (isset($view_requested_user['follow_id'])) : ?>
                                <button class="btn btn-sm js-follow" data-followed-user-id="<?php echo $view_requested_user['id']; ?>" data-follow-id="<?php echo $view_requested_user['follow_id']; ?>">ナカーマから外す</button>
                            <?php else : ?>
                                <button class="btn btn-sm btn-reverse js-follow" data-followed-user-id="<?php echo $view_requested_user['id']; ?>">ナカーマにする</button>
                            <?php endif; ?>
                        <?php else : ?>
                        <!-- 自分のページ -->
